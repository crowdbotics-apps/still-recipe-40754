"""
Django settings for still_recipe_40754 project.
...
ROOT_URLCONF = 'still_recipe_40754.urls'
...
WSGI_APPLICATION = 'still_recipe_40754.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "still_recipe_40754 API",
    "DESCRIPTION": "API documentation for still_recipe_40754 App",
    "VERSION": "v1",
}
